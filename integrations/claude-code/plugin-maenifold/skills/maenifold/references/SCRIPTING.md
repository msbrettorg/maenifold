...
## 6. Tested CLI flows (Dec 22, 2025, using ~/maenifold/bin/maenifold)
...
## 7. Prod CLI validation (Dec 22, 2025, default MAENIFOLD_ROOT)
...
## 8. Scripts for the 3.1 Technique Matrix
...
## 9. Tested outputs for section 3.1 scripts (Dec 22, 2025, prod MAENIFOLD_ROOT)
...
### 10.2. Six Hats on a Connected Concept
...
### 11.1. `agentic-research` (Single-Agent Deep Research)
...
### 11.2. `think-tank` (Multi-Agent Orchestration)
...
### 12.2. What Does Not Fit the CLI Boundary
