...
public class AdoptTools
{
    ...
    [McpServerTool]
    [Description("Adopt a role, color, or perspective by reading its JSON configuration from assets. Use ListAssets or ReadMcpResource with asset://catalog to discover available roles, colors, and perspectives before calling this tool.")]
