...
**Configuration**: Check `CLAUDE.md`, `AGENTS.md`, or `.github/copilot-instructions.md` for environment-specific values (cluster-uri, tenant, subscription, resource-group).
