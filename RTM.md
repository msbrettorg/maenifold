...
| T-SITE-001.1 | NFR-15.3, NFR-15.4, NFR-15.7 | Delete all decorative components (AnimatedGraph, AnimatedText, GlassCard, RippleButton, NetworkBackground), animation CSS, `@headlessui/react`, use-case pages, stale route pages (`app/start/`), and stale asset pages. | site/app/components/*, site/app/globals.css, site/app/use-cases/*, site/app/start/*, site/package.json | Build succeeds with zero deleted imports | Pending |
