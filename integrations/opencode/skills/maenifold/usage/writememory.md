...
- `content` (string, required): Markdown content. MUST contain at least one `[[WikiLink]]` in double brackets (e.g., `[[machine-learning]]`, `[[knowledge-graph]]`).
...
- **[[WikiLink]] required**: Content MUST contain at least one `[[WikiLink]]` (e.g., `[[research-topic]]`, `[[analysis]]`) or operation fails
